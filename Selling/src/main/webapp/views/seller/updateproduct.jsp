...
<link
	href="${pageContext.request.contextPath}/templates/seller/css/main.css"
	rel="stylesheet" type="text/css" />
<style>
body {
	display: flex;
	...
	<form action="updatepro" method="post">
		...
		<div class="modal-body">
			<div class="form-group">
				<label>Product Id</label> <input name="productId" type="text"
			...
			<div class="form-group">
				<label>Amount</label> <input name="amount" type="number"
					class="form-control" value="${product.amount}" required></input>
			</div>
			<div class="form-group">
				<label>Price</label> <input name="price" type="number"
					class="form-control" value="${product.price}" required></input>
			</div>
			<div class="form-group">
				<label>Image URL</label> <input name="imageURL" type="text"
					class="form-control" value="${product.imageURL}" required></input>
			</div>
			<div class="form-group">
		...
		<div class="modal-footer">
			<button type="button" class="btn btn-default" onclick="logout()"
				style="text-decoration: none; color: black;">Thoát</button>
